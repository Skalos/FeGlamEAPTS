...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="<?= asset_url('assets/img/faviconGlam.ico') ?>">
...
<div id="main" class="container">
    <div class="row wrapper">
        <div id="book-appointment-wizard" class="col-12 col-lg-10 col-xl-8">
            ...
            <div id="header">
                <img id="glamlogo"src="./assets/img/logo-glam.png" alt="" style="width:350px height; height: 70px">
                    ...
                    <div class="row frame-content">
                        <div class="col-12 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="(Ej. +56911122233)"id="phone-number" maxlength="60"
